        ...
        <main class="dashboard-main">
            ...
            <aside class="sidebar" id="sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <a href="#" class="nav-item has-submenu" onclick="toggleSidebarSubmenu(event, 'report-submenu')">
                        <i class="fas fa-file-alt"></i> Reports <i class="fas fa-caret-down submenu-caret"></i>
                    </a>
                    <div class="sidebar-submenu" id="report-submenu">
                        <a href="#sales-report" class="nav-item submenu-item" onclick="showSection('sales-report')">
                            Sales Report
                        </a>
                        <a href="#inventory-reports" class="nav-item submenu-item" onclick="showSection('inventory-reports')">
                            Inventory Report
                        </a>
                        <a href="#payment-reports" class="nav-item submenu-item" onclick="showSection('payment-reports')">
                            Payment Report
                        </a>
                    </div>
                    <a href="#" class="nav-item has-submenu" onclick="toggleSidebarSubmenu(event, 'accounts-submenu')">
                    ...
                    <div class="sidebar-submenu" id="accounts-submenu">
                        <a href="#access-rights" class="nav-item submenu-item" onclick="showSection('access-rights')">
                            Access Rights
                        </a>
                        <a href="#employee" class="nav-item submenu-item" onclick="showSection('employee')">
                            Employee
                        </a>
                    </div>
                    <a href="#audit-logs" class="nav-item" onclick="showSection('audit-logs')">
                ...
                <a href="#settings" class="nav-item" style="margin-top:0;" onclick="showSection('settings')">
            ...
            <div class="content-area">
                ...
                <section id="sales-report-section" class="section">
                    <div class="section-header">
                        <h2>Sales Report</h2>
                ...
                <section id="inventory-reports-section" class="section">
                    <div class="section-header">
                ...
                <section id="payment-reports-section" class="section">
                    <div class="section-header">
                ...
                <section id="access-rights-section" class="section">
                    <div class="section-header">
                ...
                <!-- Audit Logs Section -->
                <section id="audit-logs-section" class="section">
                    <div class="section-header">
                        <h2>Audit Logs</h2>
                        <div class="search-box">
                ...
                <section id="settings-section" class="section">
                    ...
                    <div class="settings-content">
                        ...
                        <div id="inventory-tab" class="settings-tab">
                            <!-- Inventory settings content removed -->
                        </div>
